        ...
        <>
            <div class="sm:hidden">
                ...
                <select id="tabs" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" onChange={e => setMode(e.target.value)}>
                    <option value='design' selected>Design a new space</option>
            ...
            <ul class="hidden text-sm font-medium text-center text-gray-500 rounded-lg shadow sm:flex">
                <li class="w-full">
                    <a href="#" class={"inline-block w-full p-4 bg-white border-r border-gray-200 rounded-s-lg hover:text-indigo-600 hover:bg-gray-50" + (mode === "design" ? "active text-indigo-600 font-semibold bg-gray-50" : "")} aria-current="page" onClick={(e) => setMode("design")}>Design a new space</a>
                </li>
                <li class="w-full">
